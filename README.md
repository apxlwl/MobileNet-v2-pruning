...
2. Pruning (prune+finetune)
   ...
   python prune.py --arch USMobileNetV2 --pruner AutoSlimPruner
    ```
## Results on Cifar10
|  BackBone| Pruner | Prune Ratio| Original/Pruned/Finetuned Accuracy | FLOPs(M)| Params(M)| args |
| :---: | :------: |:------: |  :--------------------------: | :-----------------: | :-------------------: |:-------------------: |
...
|VGG| Slimming| Optimal Thres|0.926/0.183/0.920 | 399.3->192.67|20.03->1.49|100 epoch with lr 1e-2|
